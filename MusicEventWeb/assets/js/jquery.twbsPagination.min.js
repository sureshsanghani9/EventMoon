...
! function(a, b, c, d) {
    ...
    f.prototype = {
        ...
        buildItem: function(b, c) {
            ...
            return d.addClass(this.options[b + "Class"]), d.data("page", c), d.data("page-type", b), d.append(e.attr("href", this.makeHref(c)).addClass(this.options.anchorClass).html("<span>"+f+"</span>")), d
        },
        getPages: function(a) {
            var b = [],
